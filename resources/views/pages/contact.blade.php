...
@section ('content')
    <section class="mx-auto max-w-4xl px-4 py-12">
        ...
        <a href="https://wa.me/628118500177" target="_blank" rel="noopener" class="mt-6 inline-block rounded-lg bg-emerald-600 px-5 py-3 font-semibold text-white hover:bg-emerald-700">
            Chat via WhatsApp →
        </a>
    </section>
@endsection
